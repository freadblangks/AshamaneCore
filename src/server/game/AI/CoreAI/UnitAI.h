...
struct TC_GAME_API SpellTargetSelector : public Ashamane::unary_function<Unit*, bool>
{
    public:
...
struct TC_GAME_API NonTankTargetSelector : public Ashamane::unary_function<Unit*, bool>
{
    public:
